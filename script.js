...
// تعریف رنگ‌های اصلی سیستم (پالت حرفه‌ای و مدرن)
const themeColors = {
    primary: '#00AEEF',       // آبی اصلی اسنپ (آبی روشن و جذاب)
    primaryLight: '#E6F7FF',  // آبی روشن برای پس‌زمینه
    primaryDark: '#0088CC',   // آبی تیره‌تر
    secondary: '#FF6B35',     // نارنجی جذاب برای تأکید
    accent: '#FF3860',        // قرمز/صورتی برای دکمه‌های مهم
    success: '#00D1B2',       // سبز روشن برای موفقیت
    warning: '#FFDD57',       // زرد طلایی
    danger: '#FF3860',        // قرمز برای خطاها
    info: '#3273DC',          // آبی اطلاع‌رسانی
    text: '#363636',          // متن تیره اما نه سیاه کامل
    gray: '#7A7A7A',          // خاکستری متوسط
    lightGray: '#F5F5F5',     // خاکستری بسیار روشن
    bgLight: '#FAFAFA',       // پس‌زمینه روشن
    border: '#DBDBDB',        // مرزها
    white: '#FFFFFF',         // سفید
    black: '#0A0A0A',         // سیاه نرم
    gradientStart: '#00AEEF',  // شروع گرادینت
    gradientEnd: '#0088CC',    // پایان گرادینت
    shadow: 'rgba(0, 174, 239, 0.1)', // سایه آبی ملایم
    overlay: 'rgba(10, 10, 10, 0.7)', // overlay برای مدال‌ها
};
...
class Settings {
    constructor() {
        this.settings = storage.get('snapp_settings') || {
            ...
            reward_points_rate: 10, // هر 10 افغانی = 1 امتیاز
            max_daily_trips: 20,
            cancellation_fee: 20,
            tax_rate: 0.05
        };
        ...
        <div class="modal-content" style="width: 500px;">
            ...
            <div class="modal-body">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 20px;">
                    ...
                    <div class="detail-item">
                        <label>امتیاز پاداش:</label>
                        <span><i class="fas fa-star" style="color: ${themeColors.warning};"></i> ${trip.reward_points}</span>
                    </div>
                    ` : ''}
                </div>
                ${trip.rating ? `
    ...
    notifications.forEach(notification => {
        ...
        notificationElement.innerHTML = `
            ...
            <div class="notification-actions">
                ...
                ` : ''}
                <button class="btn-delete-notification" data-id="${notification.id}">
...
function updateUserStatus(userId, status) {
    ...
    if (user) {
        ...
        sendNotificationToUser(userId, 
            status === 'approved' ? 'حساب کاربری شما تأیید شد' : 'حساب کاربری شما رد شد',
            status === 'approved' 
...
function addAdditionalStyles() {
    ...
    styleSheet.textContent = `
        ...
        :root {
            ...
            --gradient-start: ${themeColors.gradientStart};
            --gradient-end: ${themeColors.gradientEnd};
        }
