...
window.onload = function() {
    ...
    const mapHelpBtn = document.getElementById('mapHelpBtn');
    if (mapHelpBtn) {
...
function loadSettings() {
    ...
    const baseFareEconomyInput = document.getElementById('baseFareEconomy');
    if (baseFareEconomyInput) baseFareEconomyInput.value = settings.base_fare_economy;
    
    const baseFareComfortInput = document.getElementById('baseFareComfort');
    if (baseFareComfortInput) baseFareComfortInput.value = settings.base_fare_comfort;
    
    const baseFareBikeInput = document.getElementById('baseFareBike');
    if (baseFareBikeInput) baseFareBikeInput.value = settings.base_fare_bike;
    
    const distanceRateInput = document.getElementById('distanceRate');
    if (distanceRateInput) distanceRateInput.value = settings.distance_rate;
    
    const driverCommissionInput = document.getElementById('driverCommission');
    if (driverCommissionInput) driverCommissionInput.value = settings.driver_commission * 100;
    
    const minWalletBalanceInput = document.getElementById('minWalletBalance');
    if (minWalletBalanceInput) minWalletBalanceInput.value = settings.min_wallet_balance;
    
    const maxWalletBalanceInput = document.getElementById('maxWalletBalance');
    if (maxWalletBalanceInput) maxWalletBalanceInput.value = settings.max_wallet_balance;
    
    const supportPhoneInput = document.getElementById('supportPhone');
    if (supportPhoneInput) supportPhoneInput.value = settings.support_phone;
    
    const supportEmailInput = document.getElementById('supportEmail');
    if (supportEmailInput) supportEmailInput.value = settings.support_email;
}
...
if (saveSettingsBtn) {
    saveSettingsBtn.addEventListener('click', () => {
        ...
        if (appName) settings.set('app_name', appName.value);
        if (currency) settings.set('currency', currency.value);
        if (baseFareEconomy) settings.set('base_fare_economy', parseInt(baseFareEconomy.value));
        if (baseFareComfort) settings.set('base_fare_comfort', parseInt(baseFareComfort.value));
        if (baseFareBike) settings.set('base_fare_bike', parseInt(baseFareBike.value));
        if (distanceRate) settings.set('distance_rate', parseInt(distanceRate.value));
        if (driverCommission) settings.set('driver_commission', parseInt(driverCommission.value) / 100);
        if (minWalletBalance) settings.set('min_wallet_balance', parseInt(minWalletBalance.value));
        if (maxWalletBalance) settings.set('max_wallet_balance', parseInt(maxWalletBalance.value));
        if (supportPhone) settings.set('support_phone', supportPhone.value);
        if (supportEmail) settings.set('support_email', supportEmail.value);
